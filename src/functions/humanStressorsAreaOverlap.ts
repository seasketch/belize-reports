...
export async function humanStressorsAreaOverlap(
  ...
  const metricGroup = project.getMetricGroup("humanStressorsAreaOverlap");
...
export default new GeoprocessingHandler(humanStressorsAreaOverlap, {
  title: "humanStressorsAreaOverlap",
