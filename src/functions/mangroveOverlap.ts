...
export async function mangroveOverlap(
  sketch: Sketch<Polygon> | SketchCollection<Polygon>
): Promise<ReportResult> {
  const metricGroup = project.getMetricGroup("mangroveOverlap");
...
export default new GeoprocessingHandler(mangroveOverlap, {
  title: "mangroveOverlap",
